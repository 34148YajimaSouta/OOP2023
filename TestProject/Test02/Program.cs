...
namespace Test02 {
    class Program {
        ...
        private static void Exercise01(List<int> numbers) {
            var numbarSum = numbers.Sum();
            Console.WriteLine(numbarSum);
        ...
        private static void Exercise02(List<int> numbers) {
            var numberMax = numbers.Where(n => n % 2 == 0).Max();
        ...
        private static void Exercise03(List<int> numbers) {
            ...
            Console.Write(numberObj[0]);
            foreach (var n in numberObj.Skip(1)) {
                Console.Write(" " + n);
            }
        }
        ...
        private static void Exercise04(List<int> numbers) {
            ...
            var numberObj = numbers.Where(n => n <= 50&&n>=10).ToArray();
            Console.Write(numberObj[0]);
            foreach (var n in numberObj.Skip(1)) {
                Console.Write(" " + n);
            }
